...
def best_partition(graph, partition=None) :
    ...
    of the dendogram generated by the Louvain algorithm.
...
def __modularity(status) :
    """
    Compute the modularity of the partition of the graph faslty using
    status precomputed
    """
