...
#
### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ##
"""Unit tests for PyMVPA with Louvain community detection"""
...
skip_if_no_external('networkx')

import networkx as nx
import random

from mvpa2.misc.cluster import louvain_community as co

def _girvan_graphs(zout) :
    """
...
class BestPartitionTest(unittest.TestCase):
    ...
    def test_girvan(self) :
        ...
        """
        g = _girvan_graphs(4)#use small zout, with high zout results may change
...
def suite():
    return unittest.makeSuite((ModularityTest,
                               BestPartitionTest,
                               InducedGraphTest,
                               PartitionAtLevelTest,
                               GenerateDendogramTest))
